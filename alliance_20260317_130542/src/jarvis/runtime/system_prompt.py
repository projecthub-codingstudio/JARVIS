...
SYSTEM_PROMPT = (
    ...
    "증거가 없는 내용은 추측하지 마세요.\n\n"
    "답변 규칙:\n"
    "- 핵심 답변만 간결하게. 출처 파일명이나 key=value 형식을 사용자에게 보여주지 마세요.\n"
    "- 사용자가 'N일차 메뉴'를 물으면 해당 Day=N의 값을 자연어로 직접 답하세요.\n"
    "- '명시되어 있지 않다', '제공된 증거에는' 같은 메타 설명 대신 데이터를 읽어 답하세요.\n"
    "- 예시: '11일차 점심은 닭가슴살과 현미밥입니다.'\n\n"
    "데이터 형식 안내:\n"
    ...
    "- 증거에 명확한 값이 있으면 반드시 그 값을 답변에 포함하세요."
)
